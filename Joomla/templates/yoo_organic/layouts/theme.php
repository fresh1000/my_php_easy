...
<body class="<?php echo $this['config']->get('body_classes'); ?>">
    <div class="tm-wrapper">
        <div class="uk-container uk-container-center">
            ...
            <?php if ($this['widgets']->count('menu + logo + search + toolbar-c')) : ?>
            <nav class="tm-navbar uk-navbar">
                ...
                <div class="tm-toolbar-center uk-text-center"><?php echo $this['widgets']->render('toolbar-c'); ?></div>
                <?php endif; ?>
            ...
            <div class="tm-middle uk-grid" data-uk-grid-match data-uk-grid-margin>
                ...
                <p>Designed by <a href="http://mamachita.ru">Сайт города Читы</a></p>
			</div>
